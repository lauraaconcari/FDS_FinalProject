...
playlists_data = pd.read_csv('playlists.csv')  # Sostituisci 'path_to_playlists.csv' col percorso effettivo
...
top20_songs_per_tag.to_csv('top20_songs_per_tag.csv', index=False)  # Sostituisci 'path_to_top20_songs_per_tag.csv' col percorso desiderato